...
OWNER_ID = environ.get('OWNER_ID', '5983189506')
...
STREAM_API = (environ.get('STREAM_API', '384a1b6a599b42aec68078df1a53c8143b01d74d'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002076925276') #Channel / Group Id for force sub ( make sure bot is admin )
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002036743417') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002037384930') # request channel id ( make sure bot is admin )
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002037384930')) #Log channel id ( make sure bot is admin )
DUMP_CHNL = int(environ.get('DUMP_CHNL', '-1002170998708'))
...
S_GROUP = environ.get('S_GROUP', "tamil_mini")
S_CHANNEL = environ.get('S_CHANNEL', "tamil_mini")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Movie_Request_Group_07')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/tamil_mini')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/tmv_link') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : ᴄᴏᴅᴇғʟɪx ʙᴏᴛs')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/movie_request_group_07') #Support group link ( make sure bot is admin )
